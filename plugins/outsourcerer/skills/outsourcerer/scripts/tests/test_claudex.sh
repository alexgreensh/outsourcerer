...
# 4. fail-fast on missing proxy: instant die naming CLIProxyAPI, never a detached job.
...
# 5. default model: no -m under claudex resolves to gpt-5.6-sol (visible in the die message).
